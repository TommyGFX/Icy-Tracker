...
{if $this->user->getPermission('admin.user.canEditUser')}
	<form method="post" action="index.php?form=UserSearch">
		<fieldset>
			<legend>{lang}ict.acp.index.searchUsers{/lang}</legend>
...
<div class="tabMenu">
	<ul>
		{if $updates|count > 0}<li id="updates"><a onclick="tabMenu.showSubTabMenu('updates');"><span>{lang}ict.acp.index.updates{/lang}</span></a></li>{/if}
		{if $news|count > 0}<li id="news"><a onclick="tabMenu.showSubTabMenu('news');"><span>{lang}ict.acp.index.news{/lang}</span></a></li>{/if}
		<li id="system"><a onclick="tabMenu.showSubTabMenu('system');"><span>{lang}ict.acp.index.system{/lang}</span></a></li>
		<li id="stat"><a onclick="tabMenu.showSubTabMenu('stat');"><span>{lang}ict.acp.index.stat{/lang}</span></a></li>
		<li id="credits"><a onclick="tabMenu.showSubTabMenu('credits');"><span>{lang}ict.acp.index.credits{/lang}</span></a></li>
	...
	<form method="post" action="index.php?form=PackageUpdate">
		<div class="border tabMenuContent hidden" id="updates-content">
			<div class="container-1">
				<h3 class="subHeadline">{lang}ict.acp.index.updates{/lang}</h3>
				<p class="description">{lang}ict.acp.index.updates.description{/lang}</p>
				
				<ul>
					{foreach from=$updates item=update}
						<li{if $update.version.updateType == 'security'} class="formError"{/if}>
							{lang}ict.acp.index.updates.update{/lang}
							<input type="hidden" name="updates[{@$update.packageID}]" value="{$update.version.packageVersion}" />
						</li>
					{/foreach}
				</ul>
				
				<p><input type="submit" value="{lang}ict.acp.index.updates.startUpdate{/lang}" /></p>
				<input type="hidden" name="packageID" value="{@PACKAGE_ID}" />
				{@SID_INPUT_TAG}
			</div>
		</div>
...
{if $news|count > 0}
	<div class="border tabMenuContent hidden" id="news-content">
		<div class="container-1">
			<h3 class="subHeadline">{lang}ict.acp.index.news{/lang}</h3>
...
<div class="border tabMenuContent hidden" id="system-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}ict.acp.index.system{/lang}</h3>
		
		<fieldset>
			<legend>{lang}ict.acp.index.system.software{/lang}</legend>
		
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.ict.version{/lang}</p>
				<p class="formField">{PACKAGE_VERSION} (Gennam)</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.installationDate{/lang}</p>
				<p class="formField">{@INSTALL_DATE|time}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.wcf.version{/lang}</p>
				<p class="formField">{WCF_VERSION}</p>
			</div>
		</fieldset>
		
		<fieldset>
			<legend>{lang}ict.acp.index.system.server{/lang}</legend>
		
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.os{/lang}</p>
				<p class="formField">{$os}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.webserver{/lang}</p>
				<p class="formField">{$webserver}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.php{/lang}</p>
				<p class="formField">{PHP_VERSION}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.sql.type{/lang}</p>
				<p class="formField">{$sqlType} &quot;{$dbName}&quot;</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.sql.version{/lang}</p>
				<p class="formField">{$sqlVersion}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}ict.acp.index.system.cache{/lang}</p>
				<p class="formField">{$cacheSource}</p>
			</div>
			{if $load}
				<div class="formElement">
					<p class="formFieldLabel">{lang}ict.acp.index.system.load{/lang}</p>
		...
		<form method="get" action="index.php">
			<div class="formSubmit">
				<button type="submit"><img src="{@RELATIVE_WCF_DIR}icon/saveS.png" alt="" /> {lang}ict.acp.index.system.exportInformation{/lang}</button>
...
<div class="border tabMenuContent hidden" id="stat-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}ict.acp.index.stat{/lang}</h3>
		
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.stat.members{/lang}</p>
			<p class="formField">{#$members}</p>
		</div>*}
		<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.stat.usersOnline{/lang}</p>
			<p class="formField">{#$usersOnline}</p>
		</div>
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.stat.attachments{/lang}</p>
			<p class="formField">{#$attachments} ({@$attachmentsSize|filesize})</p>
		</div>*}
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.stat.database.entries{/lang}</p>
			<p class="formField">{#$databaseEntries}</p>
		</div>*}
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.stat.database.size{/lang}</p>
...
<div class="border tabMenuContent hidden" id="credits-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}ict.acp.index.credits{/lang}</h3>
		
		<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.developedBy{/lang}</p>
		...
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.productManager{/lang}</p>
			<p class="formField">Markus Bartz</p>
		</div>*}
		
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.developer{/lang}</p>
			<p class="formField">Markus Bartz</p>
		</div>*}
		
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.designer{/lang}</p>
			<p class="formField">Markus Bartz</p>
		</div>*}
		
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.contributor{/lang}</p>
			<p class="formField"></p>
		</div>*]
		
		{*<div class="formElement">
			<p class="formFieldLabel">{lang}ict.acp.index.credits.translators{/lang}</p>
			<p class="formField"></p>
		</div>*}
